...
Napi::Value KeyDownExtended(const Napi::CallbackInfo& info)
{
    Napi::Env env = info.Env();
...
Napi::Value KeyUpExtended(const Napi::CallbackInfo& info)
{
    Napi::Env env = info.Env();
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
    ...
    exports.Set(Napi::String::New(env, "keyDownExtended"), Napi::Function::New(env, KeyDownExtended));
    exports.Set(Napi::String::New(env, "keyUpExtended"), Napi::Function::New(env, KeyUpExtended));
    return exports;
}
